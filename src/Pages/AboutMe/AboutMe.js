...
const AboutMe = () => {
    return (
        <div className='hero bg-secondary md:p-8 rounded bg-opacity-50'>
            <div className="hero-content flex-col lg:flex-row-reverse">
                <div className='lg:mx-12 hover:scale-105 ease-in duration-200'>
                ...
                <div className='lg:mx-8 hover:scale-105 ease-in duration-200 max-w-lg'>
                    ...
                    <p className="py-6 text-justify">
                        Hi, I am <span className='text-primary font-bold'>Rubayet Billah</span>, a front-end developer from Bangladesh. I have been interested in computer technology since childhood. After completing my secondary education I started to gather basic programming knowledge. I choose web development to enter this IT world. Starting with HTML, CSS and now I am comfortable with front-end technologies like <span className='text-primary font-bold'>React JS, Javascript, Bootstrap, Tailwind, Firebase</span> etc and some backend technologies like <span className='text-primary font-bold'>Node JS, Express JS, MongoDB</span> etc.
                        <br />
